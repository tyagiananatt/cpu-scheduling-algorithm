...
function fetchAIReview(tableData) {
    fetch("https://api.your-ai-service.com/review", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
            "Authorization": "Bearer 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"
        },
        body: JSON.stringify({ data: tableData })
    })
    .then(response => response.json())
    .then(result => {
        document.getElementById("ai-review-output").innerText = result.review;
